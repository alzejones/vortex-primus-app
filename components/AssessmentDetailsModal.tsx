      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15 }}>
            <Text style={styles.pageTitle}>Gráficos de Evolução e Resultados</Text>
            ...
            <View ref={viewRef} collapsable={false} style={{ backgroundColor: T.card, padding: 12, borderRadius: 12 }}>
              ...
              {selectedAssessment?.anthropometry?.[0]?.body_fat != null && (
                ...
                <View style={{ backgroundColor: T.card, borderRadius: 12, padding: 12, marginBottom: 12, borderWidth: 1, borderColor: T.border, elevation: 2 }}>
                  ...
                  {(() => {
                    const mmStatus = getLocalMuscleStatus(selectedAssessment?.anthropometry?.[0]?.muscle_mass_percentage, client?.gender, calculateAge(client?.birth_date), scaleProtocol);
              ...
              <View style={{ borderBottomWidth: 1, borderBottomColor: '#e2e8f0', marginVertical: 16 }} />
