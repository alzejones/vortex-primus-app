    ...
    <View style={{ marginTop: 6 }}>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 }}>
        <Text style={{ color: theme.colors.text.secondary, fontSize: 12 }}>
          {formatValue(value, isCurrency)} <Text style={{ color: theme.colors.text.tertiary }}>de {formatValue(goal, isCurrency)}</Text>
        </Text>
    ...
    <View style={[styles.card, { borderLeftColor: color, borderLeftWidth: 4 }]}>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
          ...
          <Text style={{ color: theme.colors.text.primary, fontSize: 14, fontWeight: '700' }}>{label}</Text>
        </View>
        {onEdit && !isComputed ? (
          ...
          <View style={[styles.editBtn, { backgroundColor: 'transparent' }]}>
            <Text style={{ fontSize: 10, color: theme.colors.text.tertiary, fontStyle: 'italic' }}>ajustada</Text>
          </View>
        ) : null}
      </View>
      ...
      {selfiesData && selfiesData.total > 0 && (
        <View style={{
          ...
          <Text style={{ fontSize: 11, color: theme.colors.text.tertiary, fontWeight: '600' }}>
            📸 Selfies postadas
          </Text>
    ...
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      {editingField && (
        <View style={styles.editCard}>
          ...
          <Text style={{ fontSize: 12, color: theme.colors.text.tertiary, marginBottom: 12 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 12, marginTop: 12 }}>
            ...
            >
              <Text style={{ color: theme.colors.text.secondary, fontWeight: '700', fontSize: 14 }}>Cancelar</Text>
            </TouchableOpacity>
          </View>
        </View>
      )}
...
function createStyles(theme: any) {
  return StyleSheet.create({
    ...
    pageLabel:         { fontSize: 11, fontWeight: '700', color: theme.colors.text.tertiary, letterSpacing: 1.5, marginBottom: 4 },
    pageTitle:         { fontSize: 28, fontWeight: '900', color: theme.colors.text.primary, marginBottom: 24 },
    ...
    periodLabel:       { fontSize: 13, fontWeight: '700', color: theme.colors.text.secondary },
    periodLabelActive: { color: '#fff' },
    card:              { backgroundColor: theme.colors.card, borderRadius: 16, padding: 16, marginBottom: 16 },
    editBtn:           { backgroundColor: theme.colors.surface, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
    summaryCard:       { backgroundColor: theme.colors.card, borderRadius: 16, padding: 16, marginTop: 8 },
    summaryTitle:      { fontSize: 13, fontWeight: '700', color: theme.colors.text.secondary, marginBottom: 16, textAlign: 'center' },
    summaryRow:        { flexDirection: 'row' },
    summaryItem:       { flex: 1, alignItems: 'center' },
    summaryValue:      { fontSize: 28, fontWeight: '900', color: theme.colors.text.primary },
    summaryLabel:      { fontSize: 11, color: theme.colors.text.tertiary, marginTop: 4, fontWeight: '600' },
    ...
    editTitle:         { fontSize: 15, fontWeight: '800', color: theme.colors.text.primary, marginBottom: 6 },
    editInput:         { backgroundColor: theme.colors.surface, borderRadius: 10, padding: 14, fontSize: 24, fontWeight: '900', color: theme.colors.text.primary, textAlign: 'center', borderWidth: 1, borderColor: theme.colors.border },
